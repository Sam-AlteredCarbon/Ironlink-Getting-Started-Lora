...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, MODEM_TX_Pin|MODEM_RX_Pin);
  ...
  /* USER CODE END USART4_MspDeInit 0 */
    ...
    PB7     ------> USART4_CTS
    */
    HAL_GPIO_DeInit(GPIOA, UART2_TX_Pin|UART2_RX_Pin|UART2_RTS_Pin);

    HAL_GPIO_DeInit(UART2_CTS_GPIO_Port, UART2_CTS_Pin);
